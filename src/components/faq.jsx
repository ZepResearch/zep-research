  ...
  ({ className, title, description, items, contactInfo ,contactPath, ...props }, ref) => {
    return (
      (<section
        ref={ref}
        className={cn(
          "py-4 w-full bg-gradient-to-b from-transparent via-muted/50 to-transparent  max-w-screen-2xl mx-auto",
          className
        )}
        {...props}>
        <div className="container">
          ...
          <motion.div
            ...
            {description && (
              <Subheading className="text-sm text-muted-foreground mt-4">{description}</Subheading>
            )}
          </motion.div>
