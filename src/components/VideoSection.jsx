...
const ConferenceVideoSection = () => {
  ...
  const fetchVideos = async () => {
    try {
      const pb = getPocketBaseClient();
      const records = await pb.collection('yt_video_section').getFullList({
        sort: '-created',
      });
      setVideos(records);
    } catch (error) {
        ...
        <div className="text-center mb-12">
            <Container>
                  <div >
                    ...
                    <Subheading>  Explore highlights from our impactful conferences organized by Zepresearch</Subheading>
                  </div>
                </Container>
...
export default ConferenceVideoSection;