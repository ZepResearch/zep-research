...
export const metadata = {
  title: "Privacy-Policy | International Journal Publication and Conference",
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://zepresearch.com/PrivacyPolicy",
    images: ["/og-image.jpg"]
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://zepresearch.com/PrivacyPolicy"
  }
};
